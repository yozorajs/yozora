...
Yozora 使用 [MIT 许可证](https://github.com/yozorajs/yozora/blob/v3/LICENSE) 进行授权。
...
[src-INodePoint]: https://github.com/yozorajs/yozora/blob/v3/packages/character/src/types.ts#L10
