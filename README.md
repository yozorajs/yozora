...
- 🎨 **Extensibility**: Yozora comes with a plugin system that allows it to schedule tokenizers
  ...
  - All tokenizers can be mounted or unmounted freely.
    ...
    them are built into [@yozora/parser-yozora][] by default; you can uninstall them at will if you don't
    like them.

## Usage

- [@yozora/parser-yozora][]: (**Recommended**) A Markdown parser with rich built-in tokenizers.
...
- Parsers
  ...
  | Parser                    | Description                                                                              |
  | :------------------------ | :--------------------------------------------------------------------------------------- |
  | [@yozora/parser-yozora][] | A Markdown parser with rich built-in tokenizers                                          |
...
Yozora is [MIT licensed](https://github.com/yozorajs/yozora/blob/v3/LICENSE).
...
[github-tokenizers]: https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers
[src-NodePoint]: https://github.com/yozorajs/yozora/blob/v3/packages/character/src/types.ts#L10
...
[homepage]: https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/.#readme
...
[@yozora/tokenizer-ecma-import]:              https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-ecma-import#readme
[@yozora/tokenizer-emphasis]:                 https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-emphasis#readme
[@yozora/tokenizer-fenced-block]:             https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-fenced-block#readme
[@yozora/tokenizer-fenced-code]:              https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-fenced-code#readme
[@yozora/tokenizer-footnote]:                 https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-footnote#readme
[@yozora/tokenizer-footnote-definition]:      https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-footnote-definition#readme
[@yozora/tokenizer-footnote-reference]:       https://github.com/yozorajs/yozora/tree/v3.0.0-alpha/tokenizers/tokenizer-footnote-reference#readme
