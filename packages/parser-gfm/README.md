...
<header>
  <h1 align="center">
    <a href="https://github.com/yozorajs/yozora/tree/v2.4.0/packages/parser-gfm#readme">@yozora/parser-gfm</a>
  </h1>
  <div align="center">
...
A Markdown parser for GFM core syntax, excluding GFM extensions.
...
// Iterable source chunks are concatenated during parsing.
...
| :------------------------ | :------------------------- | :------- | :------------------- | :--------------------------------------- |
| `blockFallbackTokenizer`  | `IBlockFallbackTokenizer`  | No       | `ParagraphTokenizer` | Fallback for unmatched block content     |
| `inlineFallbackTokenizer` | `IInlineFallbackTokenizer` | No       | `TextTokenizer`      | Fallback for unmatched inline content    |
...
[homepage]: https://github.com/yozorajs/yozora/tree/v2.4.0/packages/parser-gfm#readme
