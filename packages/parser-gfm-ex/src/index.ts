...
/**
 * Parameters for constructing a gfm-ex parser.
 */
export type IGfmExParserProps = IDefaultParserProps

/**
 * Create a IParser built-in tokenizers that fully supports
 ...
 *  - @yozora/tokenizer-list (GFM extension, enabled task list item)
