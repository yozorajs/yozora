...
- 🐛 footnoteDefinitionMap is not align with the ast
  ([cdd279c](https://github.com/yozorajs/yozora/commit/cdd279c84fe5a31d26b535316e1f5d74911f5183))
...
- 🎨 re-organize codes
  ([732b49b](https://github.com/yozorajs/yozora/commit/732b49b1b3a4bbddf0ca2f18c5ba394ecd2c2347))
- ✅ update tests
  ([b9d1620](https://github.com/yozorajs/yozora/commit/b9d1620f9c8d14002056c191d43e4e5bedcae57e))
...
- 🎨 rewrite removePositions
  ([427b6c2](https://github.com/yozorajs/yozora/commit/427b6c24e12fbae0d76fc36b63c8f66cb937ede3))
...
- 🎨 add removePositions
  ([0bc66ba](https://github.com/yozorajs/yozora/commit/0bc66bad3a9bb9bff619df2ebfbd75e091629fbe))
...
- 🎨 simplify codes & fix logic errors
  ([0e20fff](https://github.com/yozorajs/yozora/commit/0e20fff295d61f85183f15b1e0feaf4011026d04))
- 🎨 simplify codes & fix logic errors
  ([c704cce](https://github.com/yozorajs/yozora/commit/c704cce0cdb66ea60f5f65b9b4e2b44014a51781))
- ✅ update snapshots
  ([9dee29c](https://github.com/yozorajs/yozora/commit/9dee29cffa44d1885af20ff700add2274fdf6e7b))
- ⬆️ upgrade devDependencies
...
- 🐛 fix logic error in the function `calcExcerptAst`
  ([37d742b](https://github.com/yozorajs/yozora/commit/37d742b0d9ec3ea8aefa4fbdd0436cecb243ff4b))
- 🐛 fix logic error in the function `calcExcerptAst` (returned an fully ast)
  ([1670497](https://github.com/yozorajs/yozora/commit/1670497549fb8e1cbca9d9026eb8f5601e92f7e1))

### Features

- 🚧 support to pass a custom matcher function as the param `aimTypes`
  ([9169bf1](https://github.com/yozorajs/yozora/commit/9169bf12d137d6aa18bd7eba3aea53ebb9b9bf7b))
...
- 🐛 fix logic errors in shallowMutateAstInPreorder
  ([0705bc6](https://github.com/yozorajs/yozora/commit/0705bc6d03dfdf5573ba2ea879a48881b0ae1745))

### Features

- 💥 rewrite @yozora/ast-util
  ([4682f00](https://github.com/yozorajs/yozora/commit/4682f00f51cbdde75dcb957bf7fc821fa307c2f7))

### Performance Improvements

- ✅ update test scripts
  ([de7081a](https://github.com/yozorajs/yozora/commit/de7081afe68a883e8c5f302d9de63398245294c8))
- 🔖 publish v1.2.0-alpha.0
  ([bd8ef45](https://github.com/yozorajs/yozora/commit/bd8ef455a22963834a70339f42178138aab28df6))
- 📝 update README
  ([2c0df72](https://github.com/yozorajs/yozora/commit/2c0df727bd815a9297777ed920f60e01c314700b))
...
- 🎨 avoid conflict in the label of footnote definitions
  ([a3f391e](https://github.com/yozorajs/yozora/commit/a3f391e768353a7d9f5fc64f9a5a4f2f888d2176))
- ✅ update tests
...
- ✅ update fixtures
  ([eeba7a0](https://github.com/yozorajs/yozora/commit/eeba7a0f514e7a5b4976d53e6f49c3626fe49ed9))
- ✅ update tests
...
- 🚧 support new utility func `searchNode`
  ([0245a54](https://github.com/yozorajs/yozora/commit/0245a54bdf8890f56b14d848d2c56965cbc95f23))

### Performance Improvements

- ✅ add tests
  ([d433cbc](https://github.com/yozorajs/yozora/commit/d433cbc0a49f2b925d238850815ed2621096b102))
...
- 🚸 avoid duplicated toc identifier
  ([a5a730c](https://github.com/yozorajs/yozora/commit/a5a730cc01532a90a24cf1d7f69124064d285929))
...
- :construction: [ast-util] feat: update ast utility funcs
  ([f9ac6c9](https://github.com/yozorajs/yozora/commit/f9ac6c964e587709022bd609b58a32e108a9409d))
...
- :construction: [ast-util] improve: perform folding case when calc identifier from yast nodes
  ([a3339d8](https://github.com/yozorajs/yozora/commit/a3339d86fc88be5e74a1c6c5ae7683114babac82))
...
- :construction: [ast-util] feat: support heading toc
  ([3ce8f94](https://github.com/yozorajs/yozora/commit/3ce8f94c7f7bc9094392fb4a718f39e1b3b12cef))
...
- ✨ add new sub-package @yozora/ast-util
  ([c347bb4](https://github.com/yozorajs/yozora/commit/c347bb44b280039d3db585d59f58e7b5da728af7))
- 🚧 expose new utilify func `replaceAST`
  ([b2144bb](https://github.com/yozorajs/yozora/commit/b2144bbd1d5282e1ddf6d0c0be57d1da5681b027))
