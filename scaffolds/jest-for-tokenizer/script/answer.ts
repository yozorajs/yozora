...
async function answerWeavers(): Promise<void> {
  ...
  await createMarkupTester(parsers.yozora, defaultMarkupWeaver)
    .scan([
      ...
      '!gfm/html-block/**/#118.json',
      '!gfm/html-block/**/#119.json',
      '!gfm/html-block/**/#122.json',
      '!gfm/html-block/**/#125.json',
      '!gfm/html-block/**/#137.json',
      '!gfm/html-block/**/#153.json',
      '!gfm/html-block/**/#157.json',
      '!gfm/html-block/**/#159.json',
      '!gfm/html-block/**/#160.json',
      ...
      '!gfm/setext-heading/**/#051.json',
      '!gfm/setext-heading/**/#052.json',
