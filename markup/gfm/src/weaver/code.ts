 ...
 * @see https://github.com/yozorajs/yozora/tree/release-2.x.x/tokenizers/tokenizer-fenced-code
 * @see https://github.com/yozorajs/yozora/tree/release-2.x.x/tokenizers/tokenizer-indented-code
 */
