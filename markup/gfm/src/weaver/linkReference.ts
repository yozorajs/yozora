 ...
 * @see https://github.com/yozorajs/yozora/tree/v3/packages/ast#linkreference
 * @see https://github.com/yozorajs/yozora/tree/v3/tokenizers/tokenizer-link-reference
 */
