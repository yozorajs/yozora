 ...
 * @see https://github.com/yozorajs/yozora/tree/v3/packages/ast#heading
 * @see https://github.com/yozorajs/yozora/tree/v3/tokenizers/tokenizer-heading
 * @see https://github.com/yozorajs/yozora/tree/v3/tokenizers/tokenizer-setext-heading
 */
