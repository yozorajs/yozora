...
[@yozora/tokenizer-autolink] produce [Link][node-type] type nodes. See [documentation][docpage] for
details.
...
[@yozora/tokenizer-autolink][] has been integrated into [@yozora/parser][] /
[@yozora/parser-gfm-ex][] / [@yozora/parser-gfm][], so you can use `YozoraParser` / `GfmExParser` /
`GfmParser` directly.

### Basic Usage

[@yozora/tokenizer-autolink][] cannot be used alone, it needs to be registered in _YastParser_ as a
