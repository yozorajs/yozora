...
<header>
  <h1 align="center">
    <a href="https://github.com/yozorajs/yozora/tree/v2.3.16/tokenizers/text#readme">@yozora/tokenizer-text</a>
  </h1>
  <div align="center">
...
[@yozora/tokenizer-text] produce [Text][node-type] type nodes. See [documentation][docpage] for
details.
...
[@yozora/tokenizer-text][] has been integrated into [@yozora/parser][] / [@yozora/parser-gfm-ex][] /
[@yozora/parser-gfm][], so you can use `YozoraParser` / `GfmExParser` / `GfmParser` directly.

### Basic Usage

[@yozora/tokenizer-text][] cannot be used alone, it needs to be registered in _YastParser_ as a
...
[homepage]: https://github.com/yozorajs/yozora/tree/v2.3.16/tokenizers/text#readme
