...
- :bug: fix(text): preserve Unicode whitespace around soft breaks
...
**Note:** Version bump only for package @yozora/tokenizer-text
...
- ✅ fix test coverage
  ([aea557e](https://github.com/yozorajs/yozora/commit/aea557e4f430966362febf346b7ffea0290f5ccf))
- 🔖 publish v2.0.2
...
- :art: [tokenizercore-inline] improve: rewrite DefaultInlineTokenizerContext to keep consistent
  with the @yozora/tokenizercore-block
  ([56fcfe8](https://github.com/yozorajs/yozora/commit/56fcfe878af7a3e4bb8daca2acf31bbca32d16fe))
