...
- :bug: fix(block-tokenizer): distinguish EOF from line endings
...
**Note:** Version bump only for package @yozora/tokenizer-heading
...
- :bug: [heading] fix: fix null pointer error
  ([9bd77c7](https://github.com/yozorajs/yozora/commit/9bd77c74b8f049a0393e619df76329c398efd16b))
...
- :construction: [heading] improve: update due to the change of @yozora/tokenizercore-block
  ([57cc73f](https://github.com/yozorajs/yozora/commit/57cc73f5c8c863d93115a5b195334cc9b2cc9c22))
- ✅ add ast positions
