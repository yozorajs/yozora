...
export const InlineHtmlCommentTagType = 'comment'
// eslint-disable-next-line @typescript-eslint/no-redeclare
export type InlineHtmlCommentTagType = typeof InlineHtmlCommentTagType
 ...
 */
export interface InlineHtmlComment extends InlineHtml, YastLiteral {
  tagType: InlineHtmlCommentTagType
}


export interface InlineHtmlCommentMatchPhaseData {
  tagType: InlineHtmlCommentTagType
  startIndex: number
  endIndex: number
}
...
export interface InlineHtmlCommentDelimiter extends InlineTokenDelimiter {
  type: InlineHtmlCommentTagType
 ...
 * @see https://github.github.com/gfm/#html-comment
 */
export function eatInlineHtmlCommentDelimiter(
  nodePoints: ReadonlyArray<EnhancedYastNodePoint>,
  startIndex: number,
  endIndex: number,
): InlineHtmlCommentDelimiter | null {
  let i = startIndex
  if (
    i + 6 >= endIndex ||
  ...
  for (i = si; i < endIndex; ++i) {
    ...
    const delimiter: InlineHtmlCommentDelimiter = {
      type: InlineHtmlCommentTagType,
      startIndex,
      endIndex: i + 3,
      contents: {
