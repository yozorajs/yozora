[![npm version](https://img.shields.io/npm/v/@yozora/tokenizer-image.svg)](https://www.npmjs.com/package/@yozora/tokenizer-image)
...
## Install
```shell
yarn add @yozora/tokenizer-image @yozora/tokenizer-core
```
