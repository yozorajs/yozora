...
**Note:** Version bump only for package @yozora/tokenizer-link-reference
...
- 🎨 rewrite link-reference due to the algorithm change & to fix bugs when using linkReference
  within footnotes
  ([4833dfb](https://github.com/yozorajs/yozora/commit/4833dfb1cbb1ea0c94fe47516fa732e9d6e14cd6))
...
- 🔧 fix wrong devDependency
  ([f99ab3b](https://github.com/yozorajs/yozora/commit/f99ab3bdd858074f485c55013f39b9b2cc2951dd))
